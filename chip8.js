...
// include: C:\Users\jossi\AppData\Local\Temp\tmpfnmde7qm.js
...
Module['FS_createPath']("/", "ROMS", true, true);
    ...
    loadPackage({"files": [{"filename": "/ROMS/Airplane.ch8", "start": 0, "end": 356}, {"filename": "/ROMS/test_opcode.ch8", "start": 356, "end": 834}], "remote_package_size": 834});

  })();

// end include: C:\Users\jossi\AppData\Local\Temp\tmpfnmde7qm.js
// include: C:\Users\jossi\AppData\Local\Temp\tmp5_fr8gmm.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if ((typeof ENVIRONMENT_IS_WASM_WORKER != 'undefined' && ENVIRONMENT_IS_WASM_WORKER) || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD) || (typeof ENVIRONMENT_IS_AUDIO_WORKLET != 'undefined' && ENVIRONMENT_IS_AUDIO_WORKLET)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: C:\Users\jossi\AppData\Local\Temp\tmp5_fr8gmm.js
// include: C:\Users\jossi\AppData\Local\Temp\tmps6e8ylr9.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach((task) => {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: C:\Users\jossi\AppData\Local\Temp\tmps6e8ylr9.js
...
var ASM_CONSTS = {
 ...
 155782: ($0) => { if (Module['canvas']) { Module['canvas'].style['cursor'] = UTF8ToString($0); } },  
 155865: () => { if (Module['canvas']) { Module['canvas'].style['cursor'] = 'none'; } },  
 155934: () => { return window.innerWidth; },  
 155964: () => { return window.innerHeight; }
};
